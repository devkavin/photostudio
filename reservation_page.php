            ...
            <div class="card-body">
                ...
                <form id="reservation-form" action="make_reservation.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker" id="reservation-date" name="reservation-date" placeholder="Select Date" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="price" name="price" placeholder="Enter Advance Payment Price" required>
                    </div>
